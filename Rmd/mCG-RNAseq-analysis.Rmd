...
on_genes <- rowMeans(counts(dds, normalize = TRUE)[,dds$condition == "Control"]) >= 20
dds <- dds[on_genes,]
dds_global <- dds_global[on_genes,]
...
```
Looks like there are `r de` significantly DE genes and `r ee` non-DE genes (at FDR 0.05), where
...
B2
# save plot for mutlipanel figure
saveRDS(B2, file="../plots/B2_allgenes.rds")
